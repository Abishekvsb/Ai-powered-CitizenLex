...
export default function Login() {
  ...
  const handleRegisterSubmit = async (e) => {
    ...
    try {
      ...
      setRegSuccess(true);
      setTimeout(() => {
        // Clear registration form and switch focus or notify
        setRegSuccess(false);
        setRegName('');
        setRegEmail('');
        setRegMobile('');
  ...
  return (
    <div className="auth-page-wrapper" style={{
      ...
      {/* 3D background constellations, Lady Justice, Court pillars, books & gavel */}
      <ThreeDBackground />
        ...
        <div className="row g-4 align-items-stretch">
          ...
          <div className="col-lg-6 col-12">
            <div className="glass-premium-card shimmer-border h-100 d-flex flex-column justify-content-between" style={{
              ...
              {/* Left illustration inside card: 3D glowing scales */}
              <div>
                <div className="d-flex flex-column align-items-center justify-content-center p-3 mt-4 position-relative" style={{
                  ...
                  {/* Glowing scales SVG illustration */}
          ...
          <div className="col-lg-6 col-12">
            <div className="glass-premium-card shimmer-border h-100 d-flex flex-column justify-content-between" style={{
              ...
              {/* Right illustration inside card: 3D glowing shield */}
              <div>
                <div className="d-flex flex-column align-items-center justify-content-center p-3 mt-4 position-relative" style={{
                  ...
                  {/* Glowing shield SVG illustration */}
                  <svg width="70" height="70" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
